        ...
        <?php
            query("SELECT 
                         ...
                         FROM 
                             project 
                         JOIN 
                             team ON project.team_id = team.id 
                         WHERE project.id = ?",
                    "getProjectDetails", $_SESSION["selected_project_id"]);
            ...
            query("SELECT 
                         ...
                         FROM 
                             task 
                         JOIN 
                             user ON task.assigned_user_id = user.id 
                         WHERE task.project_id = ?",
                "getTaskDetails", $_SESSION["selected_project_id"]);
        ?>
