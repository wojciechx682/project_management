...
<div class="project-details">
    ...
    <div class="project-details-id">%s</div>
</div>
<div class="project-details">
    <div class="project-details-name-left">Project name</div>
    <div class="project-details-name">%s</div>
</div>
<div class="project-details">
    <div class="project-details-desc-left">Description</div>
    <div class="project-details-desc">%s</div>
</div>
<div class="project-details">
    <div class="project-details-start-date-left">Start date</div>
    <div class="project-details-start-date">%s</div>
</div>
<div class="project-details">
    <div class="project-details-end-date-left">End date</div>
