...
<div class="task task-content">
    ...
    <div class="task-title">
        <a href="#" onclick="toggleTaskDetails()">%s</a>
    </div>
    ...
    <div class="task-assigned-user">%s</div>
    ...
    <div class="task-manage">
        ...
        <div class="task-options-container">
            <div class="task-action-options hidden">
                <div class="task-option" onclick="toggleEditTaskWindow()">Edit</div>
                <div class="task-option task-option-delete" onclick="toggleDeleteTaskWindow()">Delete</div>
            </div>
        </div>
    </div>
</div>
